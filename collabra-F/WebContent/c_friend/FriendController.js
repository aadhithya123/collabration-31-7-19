myApp.controller("Friendcontroller",function($scope,$rootScope,$http,$location)
{
	...
	function showFriendList()
	{
		...
		$http.post('http://localhost:8080/ConnectPeopleMiddle/showFriendList/'+$rootScope.currentUser.username)
	...
	function showPendingFriendList()
	{
		...
		$http.post('http://localhost:8080/ConnectPeopleMiddle/showPendingRequest/'+$rootScope.currentUser.username)
		.then(function(response)
		{
	...
	function showSuggestedFriendList()
	{
		...
		$http.post('http://localhost:8080/ConnectPeopleMiddle/showSuggestedFriend/'+$rootScope.currentUser.username)
		.then(function(response)
		{
	...
	$scope.sendFriendRequest=function(friendname)
	{
		...
		$http.post('http://localhost:8080/ConnectPeopleMiddle/sendFriendRequest/'+friendid)
		.then(function(response)
		{
	...
	$scope.accept=function(friendid)
	{
		...
		$http.post('http://localhost:8080/ConnectPeopleMiddle/acceptFriendRequest/'+friendid)
		.then(function(response)
		{
	...
	$scope.unFriend=function(friendid)
	{
		...
		$http.post('http://localhost:8080/ConnectPeopleMiddle/deleteFriendRequest/'+friendid)
		.then(function(response)
		{
